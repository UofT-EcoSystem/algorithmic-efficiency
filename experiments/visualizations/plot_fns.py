...
csvs = [
  './experiments/augmentation/saved/cifar10_exp3/no_aug/all_measurements.csv',
  './experiments/augmentation/saved/cifar10_exp3/all_aug/all_measurements.csv',
  './experiments/augmentation/saved/cifar10_exp3/geo_aug/all_measurements.csv',
  './experiments/augmentation/saved/cifar10_exp3/tex_aug/all_measurements.csv',
]
labels = [
  'no_aug',
  'all_aug',
